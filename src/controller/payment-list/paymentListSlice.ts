...
export const paymentListSlice = createSlice({
    ...
    reducers: {
        ...
        setShowDetailModal: (state: InitialState, action: PayloadAction<boolean>) => {
...
export const { setSelectedPaymentRequest, setShowCancelModal, setShowWithdrawModal, setShowTransferModal, setShowDetailModal} = paymentListSlice.actions;
